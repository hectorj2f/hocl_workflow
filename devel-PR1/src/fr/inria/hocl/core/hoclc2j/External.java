...
public class External implements Atom {
	...
	public void addVar(MoleculeVarPat moleculeVarPat){
		occuringVars.add(moleculeVarPat);
	}
	
	//FIXME: Hector Tuple, Solution are supported type as return value in a javaExpresion
	
	public String generateReference() {
		return "ExternalObject.getHOCL_TypeTranslation(" + javaExpression + ")";
	}
