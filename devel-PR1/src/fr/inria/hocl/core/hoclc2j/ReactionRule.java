...
public class ReactionRule implements Atom {
	...
	public void setRuleName( String newName ) {
		ruleName = newName;
		reactionRuleClassName = Hoclc2j.upperFirstLetter( ruleName );
	}
	...
	public String generateClass() {
		...
		s = "class "
				...
				+ "\n"
				+ Hoclc2j.indentCode( genConstructor( symbolsTable ) )
				+ "\n"
				...
				// // ,0
				+ "\n"
				+ "\tpublic "+reactionRuleClassName+ " clone() {\n"
				+ "\t\t return new "+reactionRuleClassName+"();\n"
				+ "\t}"
				+ "\n"
				...
				+ Hoclc2j.indentCode( 2, result.generateAllVariablesDeclaration( this
						.getArguments() ) ) + "\n"
				+ Hoclc2j.indentCode( 2, result.generateDeclarationInit() ) + "\n"
	...
	private String genConstructor( SymbolsTable symbolsTable ) {
		...
		s = "public "
				...
				+ Hoclc2j.indentCode( pattern.generatePatternDeclaration(
